...
class Pagination
{
    ...
    {   
        ...
        {
            $p = '<nav aria-label="Pagination"><ul class="pagination justify-content-center">';
            ...
            for ($i = $this->_config['min']; $i <= $this->_config['max']; $i++)
            {
                ...
                if ($this->_config['current_page'] == $i){
                    $p .= '<li class="page-item active"><a class="page-link" href="#">'.$i.'<span class="sr-only">(current)</span></a></li>';
                }
                else{
